...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                ADD_SHOWS_WO_DIR, AUTO_RENAME, DOC_USE_NAMES,SPEC_USE_NAMES, nameExceptionScheduler, USE_SUBTITLES, SUBTITLES_LANGUAGES, SUBTITLES_DIR, SUBTITLES_SERVICES_LIST, SUBTITLES_SERVICES_ENABLED, subtitlesFinderScheduler
...
def start():
    ...
    global __INITIALIZED__, currentSearchScheduler, backlogSearchScheduler, \
            ...
            subtitlesFinderScheduler, started, USE_SUBTITLES, nameExceptionScheduler
...
def halt ():
    ...
    global __INITIALIZED__, currentSearchScheduler, backlogSearchScheduler, showUpdateScheduler, \
            ...
            nameExceptionScheduler, subtitlesFinderScheduler, started
